      ...
      >
        <div className="bg-white/80 backdrop-blur-xl border border-white/50 rounded-[2.5rem] shadow-2xl p-8 md:p-10">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-500 mt-2 font-medium">Create your AI Study space</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-slate-50/50 border-2 border-slate-100 rounded-2xl focus:outline-none focus:border-emerald-500 focus:bg-white transition-all font-medium text-slate-900"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full py-7 rounded-2xl bg-emerald-500 hover:bg-black text-white text-lg font-bold shadow-xl shadow-emerald-100 transition-all hover:-translate-y-1 active:scale-95 group"
            >
              {loading ? (
          ...
          <p className="mt-8 text-center text-slate-500 font-bold">
            ...
            <Link href="/login" className="text-emerald-600 hover:text-black transition-colors underline decoration-2 underline-offset-4">
              Sign In
            </Link>
          </p>
        </div>
